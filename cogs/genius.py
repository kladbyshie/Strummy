    ...
    async def genius(self, ctx, *args):
        ...
        while True:
            try:
                ...
                await ctx.send(f"I read that as `{message.content}`, which isn't an option. Try entering the # again, or enter 'no' to exit the search command.")
                continue
